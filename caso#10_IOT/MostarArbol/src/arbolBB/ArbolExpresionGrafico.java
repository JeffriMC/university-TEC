...
public class ArbolExpresionGrafico extends JPanel 
{
     ...
     */
    private Dimension calcularTamSubarbol(Nodo n) 
    {
          if (n == null) 
              return new Dimension(0,0);
 
          Dimension ld = calcularTamSubarbol(n.getIzq());
          Dimension rd = calcularTamSubarbol(n.getDer());
